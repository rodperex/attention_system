...
PID::PID(double min_ref, double max_ref, double min_output, double max_output)
{
  min_ref_ = min_ref;
  max_ref_ = max_ref;
...
void
PID::set_pid(double min_ref, double max_ref, double min_output, double max_output)
{
  min_ref_ = min_ref;
  max_ref_ = max_ref;
  min_output_ = min_output;
...
void
PID::set_constants(double n_KP, double n_KI, double n_KD)
{
  KP_ = n_KP;
  KI_ = n_KI;
  KD_ = n_KD;
...
double
PID::get_output(double new_reference)
{
